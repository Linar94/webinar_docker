...
from .serializers import (
    CommentSerializer, PostSerializer, UserSerializer, StarSerializer, UploadImageSerializer
)
...
class PostViewSet(
    ...
    @action(methods=("PATCH",), detail=True, parser_classes=[MultiPartParser])
    def upload_image(self, request, *args, **kwargs):
        img = request.data.get("img")
        post = self.get_object()
        post.image.save(name=img.name, content=img)
